...
public class SwaggerConfiguration {
	...
	OpenAPI myConfiguration() {
		...
		// OpenAPI has fields info,tag,extension,security,path...
		...
		contact.setEmail("24bcb070@ietdavv.edu.in");
		info.setContact(contact);
		info.setSummary("Make songs favorite, create public/private Playlist & search songs on the basis of your need!");
